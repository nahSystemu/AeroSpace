...
public struct ArgParserInput {
    ...
    func consumeOneArg<T>(_ parser: (String) -> Parsed<T>) -> ParsedCliArgs<T> { .init(parser(arg), advanceBy: 1) }
...
public func parseCardinalDirectionArg(i: ArgParserInput) -> ParsedCliArgs<CardinalDirection> {
    i.consumeOneArg { arg in parseEnum(arg, CardinalDirection.self) }
}

func parseCardinalOrDfsDirection(i: ArgParserInput) -> ParsedCliArgs<CardinalOrDfsDirection> {
    i.consumeOneArg { arg in parseEnum(arg, CardinalOrDfsDirection.self) }
}
