= hyprspace-move-node-to-workspace(1)
include::util/man-attributes.adoc[]
:manname: hyprspace-move-node-to-workspace
// tag::purpose[]
...
[verse]
// tag::synopsis[]
hyprspace move-node-to-workspace [-h|--help] [--focus-follows-window] [--wrap-around]
                                 [--stdin|--no-stdin]
                                 (next|prev)
hyprspace move-node-to-workspace [-h|--help] [--focus-follows-window] [--fail-if-noop]
...
This flag is a shortcut for manually running `hyprspace-workspace`/`hyprspace-focus` after `move-node-to-workspace` successful execution.
