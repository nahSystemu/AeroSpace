= hyprspace-macos-native-fullscreen(1)
include::util/man-attributes.adoc[]
:manname: hyprspace-macos-native-fullscreen
// tag::purpose[]
...
[verse]
// tag::synopsis[]
hyprspace macos-native-fullscreen [-h|--help] [--window-id <window-id>]
hyprspace macos-native-fullscreen [-h|--help] [--window-id <window-id>] [--fail-if-noop] on
hyprspace macos-native-fullscreen [-h|--help] [--window-id <window-id>] [--fail-if-noop] off
