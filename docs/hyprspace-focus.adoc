...
[verse]
// tag::synopsis[]
hyprspace focus [-h|--help] [--ignore-floating]
                [--boundaries <boundary>] [--boundaries-action <action>]
                (left|down|up|right)
hyprspace focus [-h|--help] [--ignore-floating]
                [--boundaries <boundary>] [--boundaries-action <action>]
                (dfs-next|dfs-prev)
hyprspace focus [-h|--help] --window-id <window-id>
hyprspace focus [-h|--help] --dfs-index <dfs-index>
...
https://github.com/nikitabobko/HyprSpace/issues/5
