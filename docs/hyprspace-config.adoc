...
:manname: hyprspace-config
// tag::purpose[]
:manpurpose: Query HyprSpace config options
// end::purpose[]
...
[verse]
// tag::synopsis[]
hyprspace config [-h|--help] --get <name> [--json] [--keys]
hyprspace config [-h|--help] --major-keys
hyprspace config [-h|--help] --all-keys
hyprspace config [-h|--help] --config-path
...
+
----
$ hyprspace config --get mode --keys
main
service
----
...
+
----
$ hyprspace config --get mode.main.binding --json
{
  "alt-w" : "workspace W",
  "alt-y" : "workspace Y",
  "alt-n" : "workspace N",
