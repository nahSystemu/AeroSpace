= hyprspace-move-mouse(1)
include::./util/man-attributes.adoc[]
// tag::purpose[]
:manpurpose: Move mouse to the requested position
// end::purpose[]
:manname: hyprspace-move-mouse

// =========================================================== Synopsis
== Synopsis
[verse]
// tag::synopsis[]
hyprspace move-mouse [-h|--help] [--fail-if-noop] <mouse-position>
...
`hyprspace move-mouse window-lazy-center || hyprspace move-mouse monitor-lazy-center`
