= hyprspace-focus-monitor(1)
include::util/man-attributes.adoc[]
:manname: hyprspace-focus-monitor
// tag::purpose[]
...
[verse]
// tag::synopsis[]
hyprspace focus-monitor [-h|--help] [--wrap-around] (left|down|up|right)
hyprspace focus-monitor [-h|--help] [--wrap-around] (next|prev)
hyprspace focus-monitor [-h|--help] <monitor-pattern>...
