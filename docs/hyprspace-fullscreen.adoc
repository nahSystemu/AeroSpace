= hyprspace-fullscreen(1)
include::util/man-attributes.adoc[]
:manname: hyprspace-fullscreen
// tag::purpose[]
...
[verse]
// tag::synopsis[]
hyprspace fullscreen [-h|--help]     [--window-id <window-id>] [--no-outer-gaps]
hyprspace fullscreen [-h|--help] on  [--window-id <window-id>] [--no-outer-gaps] [--fail-if-noop]
hyprspace fullscreen [-h|--help] off [--window-id <window-id>] [--fail-if-noop]
