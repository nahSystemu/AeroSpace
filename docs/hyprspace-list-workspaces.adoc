= hyprspace-list-workspaces(1)
include::util/man-attributes.adoc[]
:manname: hyprspace-list-workspaces
// tag::purpose[]
...
[verse]
// tag::synopsis[]
hyprspace list-workspaces [-h|--help] --monitor <monitor>... [--visible [no]] [--empty [no]] [--format <output-format>] [--count] [--json]
hyprspace list-workspaces [-h|--help] --all [--format <output-format>] [--count] [--json]
hyprspace list-workspaces [-h|--help] --focused [--format <output-format>] [--count] [--json]
