= hyprspace-list-windows(1)
include::util/man-attributes.adoc[]
:manname: hyprspace-list-windows
// tag::purpose[]
...
[verse]
// tag::synopsis[]
hyprspace list-windows [-h|--help] (--workspace <workspace>...|--monitor <monitor>...)
                       [--monitor <monitor>...] [--workspace <workspace>...]
                       [--pid <pid>] [--app-bundle-id <app-bundle-id>] [--format <output-format>]
                       [--count] [--json]
hyprspace list-windows [-h|--help] --all [--format <output-format>] [--count] [--json]
hyprspace list-windows [-h|--help] --focused [--format <output-format>] [--count] [--json]
...
%{window-is-fullscreen}:: Boolean. Is window in fullscreen by `hyprspace fullscreen` command
