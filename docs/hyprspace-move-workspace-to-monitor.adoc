= hyprspace-move-workspace-to-monitor(1)
include::util/man-attributes.adoc[]
:manname: hyprspace-move-workspace-to-monitor
// tag::purpose[]
...
[verse]
// tag::synopsis[]
hyprspace move-workspace-to-monitor [-h|--help] [--workspace <workspace>] [--wrap-around] (left|down|up|right)
hyprspace move-workspace-to-monitor [-h|--help] [--workspace <workspace>] [--wrap-around] (next|prev)
hyprspace move-workspace-to-monitor [-h|--help] [--workspace <workspace>] <monitor-pattern>...
