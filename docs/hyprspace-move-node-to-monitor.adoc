= hyprspace-move-node-to-monitor(1)
include::util/man-attributes.adoc[]
:manname: hyprspace-move-node-to-monitor
// tag::purpose[]
...
[verse]
// tag::synopsis[]
hyprspace move-node-to-monitor [-h|--help] [--window-id <window-id>] [--focus-follows-window]
...
This flag is a shortcut for manually running `hyprspace-workspace`/`hyprspace-focus` after `move-node-to-monitor` successful execution.
