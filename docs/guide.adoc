...
[source,bash]
----
brew install --cask nikitabobko/tap/hyprspace@0.12.0
----

[#manual-installation]
=== Manual installation

. Download the latest available zip from https://github.com/nikitabobko/HyprSpace/releases[releases page]
. Unpack zip
...
* Wrong window may receive focus in multi monitor setup: https://github.com/nikitabobko/HyprSpace/issues/101[#101] (Bug in Apple API)
* Wrong borderless Alacritty window may receive focus in *single monitor* setup: https://github.com/nikitabobko/HyprSpace/issues/247[#247] (Bug in Apple API)
* Performance issues: https://github.com/nikitabobko/HyprSpace/issues/333[#333]
* macOS randomly switches focus back: https://github.com/nikitabobko/HyprSpace/issues/289[#289]
...
Please post your use cases to https://github.com/nikitabobko/HyprSpace/issues/20[the issue] if you want other commands to get supported.
