...
[verse]
// tag::synopsis[]
hyprspace workspace [-h|--help] [--auto-back-and-forth] [--fail-if-noop] <workspace-name>
hyprspace workspace [-h|--help] [--wrap-around] [--stdin|--no-stdin] (next|prev)
...
`hyprspace list-workspaces --monitor focused --empty no | hyprspace workspace next`
